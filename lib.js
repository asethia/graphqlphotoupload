...
// going to get user detail like id, login, avatar_url, name, etc.
const requestGithubUserAccount = token => 
    fetch(`https://api.github.com/user?access_token=${token}`)
        .then(res => res.json())
       
// credentials object conatins client_id, client_secret and auth code     
// this will return user detail with token
